      ...
      <div class="flex flex-col flex-grow overflow-y-auto bg-white border-r">
        ...
        <div class="flex flex-col flex-grow px-4 mt-5">
          <nav class="flex-1 space-y-1 bg-white">
            ...
            <ul>
              <li>
                <a class="inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-blue-500" href="{{route('admin.products.index')}}">
              ...
              <li>
                <a class="inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-blue-500" href="{{route('admin.products.create')}}">
