<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 h-[120px]">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/">
                        <img src="{{ Vite::asset("/public/images/3636.svg") }}" alt="">
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-red-50 z-10">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">{{ Auth::user()->first_name?? 'guest' }}</div>
